...
export const physicsExample: DiagramSpec = {
  ...
  nodes: [
    ...
    {id: 'weight', shape: 'circle', label: '', x: 540, y: 120, width: 60, height: 60, fill: 'white'},
    {id: 'pivot', shape: 'circle', label: '', x: 400, y: 330, width: 20, height: 20, fill: 'white'},
    {id: 'floor', shape: 'rect', label: '', x: 400, y: 530, width: 780, height: 20, fill: 'gray'},
    {id: 'title', shape: 'text', label: '작은 입력, 커지는 움직임', x: 400, y: 50, width: 600, height: 40, fill: 'none'},
  ],
  events: [],
  physics: {
