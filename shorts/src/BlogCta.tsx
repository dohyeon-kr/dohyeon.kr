...
export const BlogCta: React.FC<{layer: SceneLayer; scene: RenderScene}> = ({layer, scene}) => (
  <AbsoluteFill style={{background: layer === 'visual' ? '#080808' : undefined, color: '#fff', fontFamily: 'Pretendard, Arial, sans-serif'}}>
    ...
    {layer === 'text' && <div style={{position: 'absolute', left: '50%', top: '50%', width: 864, transform: 'translate(-50%, -50%)', textAlign: 'center'}}>
      ...
      <div style={{marginTop: 64, fontSize: 60, fontWeight: 600, lineHeight: 1.4, display: 'inline-block', borderBottom: '3px dashed #fff', paddingBottom: 12}}>{BLOG_URL}</div>
