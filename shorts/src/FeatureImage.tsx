...
registerRoot(() => <Composition id="FeatureImage" component={FeatureImage} width={1600} height={900} fps={30} durationInFrames={1} defaultProps={{plan: {title: ['판단을 규칙으로', '릴스 자동화를 만든 과정'], relationship: 'sequence', labels: [['문제', '발견'], ['판단을', '규칙으로'], ['검증과', '자동수정']], description: '문제 발견에서 판단의 규칙화, 검증과 자동 수정으로 이어지는 릴스 제작 과정'}}} />);
