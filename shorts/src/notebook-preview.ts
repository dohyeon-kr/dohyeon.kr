...
export const notebookDiagrams:DiagramSpec[]=[
  {...base,description:'프론트엔드가 사용할 SDK 버전을 선택한다',nodes:[
    ...
    {...node('selected','선택',320,112,120,78),role:'sticker',fill:'white'},
...
export const notebookPreviewProps:RenderManifest={...templatePreviewProps,id:'error-notebook-preview',
  presenterOverlay:{position:'bottom-right',frame:'torn-paper-blue',hideOnCommonCta:true,lipSync:'none',nod:'none'},
  scenes:[...notebookDiagrams.map((diagramSpec,i):RenderScene=>({
    ...templatePreviewProps.scenes[0],headline:'',subline:null,layout:'diagram-centered',transition:'fade',
