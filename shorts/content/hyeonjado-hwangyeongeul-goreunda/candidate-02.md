...
- 배치: 문장을 비대칭으로 배치
- 전달할 관계: 떠남의 의미를 묻고 다음 장면의 상황으로 연결한다.
- 표현 방식: 아이콘 — 열린 문
- 표현 이유: 짧은 문구와 충분한 여백으로 질문을 읽을 시간을 확보한다.
...
- 배치: 큰 문장을 중심에 배치
- 전달할 관계: 질문과 시도의 부담이 한 사람에게 집중되는 상황을 제시한다.
- 표현 방식: 문장 중심
- 표현 이유: 짧은 문구와 충분한 여백으로 질문을 읽을 시간을 확보한다.
