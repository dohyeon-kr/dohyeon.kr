...
## 2. 핵심 메시지 — 조금 미안한 일일지도

**내레이션**

옆에 물어볼 사람이 있다는 건 꽤 편합니다. 그러다 보니 문서를 읽으면 알 수 있는 것까지 묻게 됩니다. 조금 미안한 일일지도 모르겠네요.
...
그래도 함께 화면을 보고 이야기하는 건 즐겁습니다. 애매했던 요구사항이 정리되고, 생각하지 못한 방법을 찾기도 합니다. 이번에는 같이 일한 경험에 대해 나누고자 합니다.
