...
![Current 1.5× portrait framing](presenter-zoom.png)

The current portrait scales all character layers uniformly by 1.5 relative to the original portrait around (627, 135),
