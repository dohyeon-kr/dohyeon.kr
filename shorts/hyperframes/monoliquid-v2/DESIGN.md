...
High-contrast monochrome editorial motion with a black outer frame, white/paper canvas, square geometry, thin registration rules, industrial nickel accents and restrained black-metal texture. Korean copy uses Pretendard; terse Latin labels use Archivo Expanded. Composition should feel like a printed technical/editorial sheet brought to life, not a rounded SaaS card UI. Motion is sharp and subtle: short vertical entrances, line reveals, hard cuts and restrained wipes. Visual hierarchy comes from scale, whitespace, rules and inversion rather than decorative color.
...
No chromatic accent is introduced in v2. Emphasis uses black/white inversion, nickel, rule weight and scale.
...
- Reserve bottom-right presenter zone even before presenter parity is implemented: x 780–1010, y 1430–1700.
- Corners are square. `border-radius: 0` for content panels. Circles are reserved for semantic nodes or presenter framing.
- Use 1–3 px black rules, registration ticks and rectangular labels.

## Scene Language

### Hero

One large idea. Oversized headline, compact source/section label, optional monochrome photo plate. The first frame must communicate the subject without requiring the caption.

### Statement

A single sentence or contrast. Use scale and black/white inversion rather than extra icons. Keep one dominant block and at most one supporting block.

### Photo

Use a large documentary/editorial image. Desaturate visually through CSS. Do not add decorative frames beyond the Monoliquid rule system. Preserve attribution in release metadata outside the composition.
...
Minimal. Return to the core sentence or CTA. Do not fill the canvas with secondary information.
...
- Captions must stay left of the reserved presenter zone where possible.
...
- No gradients, neon or arbitrary brand colors.
